...
$peopleCount = $get_number_of_people->fetch_assoc();
?>
...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <div class="container-fluid">
            <div class="product-status-wrap" style="margin-top: 2rem;">
                <div class="add-product">
                    <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" style="margin-bottom: 20px;">Add People</button>
                </div>
        ...
        <div class="footer-copyright-area" style="margin-top: 1rem;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
